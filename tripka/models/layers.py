...
class EmbedInput(nn.Module):
    def __init__(self,
                 ...
                 num_3d_kernels      = 128       ,
                 charge_dictionary   = None      ,
                 pretrain_withcharges = False    ,
                 ):
        super().__init__()
    ...
    def forward(self, inputs):
        """
        node_features -> h
        feature_matrix, distance_matrix, (dist_input, node_features) -> e
        """
        ...
        charge_emb = self.charge_embed(g.src_charges.long())
        h += charge_emb
...
class GaussianLayer(nn.Module):
    ...
    def forward(self, x, edge_types):
        ...
        #     print(x.device)
        #     print(self.means.weight.device)
