...
class Trainer(object):
        ...
        if last_optim_state is not None and not reset_optimizer:
            if extra_state is not None:
                epoch_itr = self.get_train_iterator(
                    epoch=extra_state["train_iterator"]["epoch"], load_dataset=True
                )
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        self.zero_grad()
        # print(self.args.accumulate_size,',1111111debugdebugdebugdebug') # work
        # samples = samples + samples
        # print(len(samples),',1111111debugdebugdebugdebug') # work  
        # print(samples)
        ...
        # print(sample_size, ',1111111debugdebugdebugdebug')
